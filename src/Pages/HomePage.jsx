...
const team = [
    {
        avatar: "https://stanjhae.vercel.app/assets/green-30898c2e.png",
        name: "Stanley Ajaero",
        title: "ALX Software Engineer (Cohort 19)",
        desc: "Paasion for building websites",
        linkedin: "#",
        twitter: "#",
    }
]
...
const features = [
    {
        ...
        title: "Fast Render",
        desc: "Quick rendering of Data into any visual representation"
    },
    {
        icon:
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        title: "Data sanitization & security",
        desc: "Modify Data to ensure it is safe and secure"
    },
    {
        icon:
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
        ...
        title: "Use on your terms",
        desc: "Freedom to use and Quick Exportation into PDF"
    },
]
                  ...
                  <section className="mt-24 mx-auto max-w-screen-xl pb-12 px-4 items-center lg:flex md:px-8">
                      <div className="space-y-4 flex-1 sm:text-center lg:text-left">
                          <h1 className="text-white font-bold text-4xl xl:text-5xl">
                              Visualize Data in
                               <span className="text-indigo-400"> React Graph Agency</span>
                          </h1>
                          <p className="text-gray-300 max-w-xl leading-relaxed sm:mx-auto lg:ml-0">
                              We make data visualization more easier and better
                          </p>
                          <div className="pt-10 items-center justify-center space-y-3 sm:space-x-6 sm:space-y-0 sm:flex lg:justify-start">
                              <Link to="/products" className="px-7 py-3 w-full bg-white text-gray-800 text-center rounded-md shadow-md block sm:w-auto">
                                  Get started
                              </Link>
                              <Link to="products/contact-us" className="px-7 py-3 w-full bg-gray-700 text-gray-200 text-center rounded-md block sm:w-auto">
                                  Contact US
                              </Link>
                          </div>
                      </div>
                ...
                <section className="relative py-28 bg-gray-900">
                    <div className="relative z-10 max-w-screen-xl mx-auto px-4 text-gray-300 justify-between gap-24 lg:flex md:px-8">
                        <div className="max-w-xl">
                            ...
                            <p className="mt-3">
                                Experience fast data optimization with our visualization software
                            </p>
                        </div>
                        ...
                        <div className="items-center gap-x-12 sm:px-4 md:px-0 lg:flex">
                            ...
                            <div className="max-w-xl px-4 space-y-3 mt-6 sm:px-0 md:mt-0 lg:max-w-2xl">
                                ...
                                <p className="mt-3 text-gray-400">
                                    Graphito is a data visualization tool that allows users to easily create and share interactive charts and graphs. With Graphito, users can upload their data, select the type of chart they want to create, and then customize the appearance and layout of their visualization. Once the visualization is complete, it can be embedded in a web page or shared with others.
                                </p>
                                <p className="text-gray-100 text-xl font-semibold sm:text-2xl">
                                    Inspiration
                                </p>
                                <p className="mt-3 text-gray-400">
                                    Once upon a time, i was trying to convert a csv data into visual charts but it required me to use MsExcel but my licence was expired so i was left stranded luckily i got to borrow a colleague laptop to solve my problem. 
                                    After the seminar, i asked myself what if i had a tool that could solve that problem for me on the web and the idea stuck with me. After doing some research, i discovered some resources that could help and i started building. The name &quot;graphito &quot; came to mind after my friend that was a victim of war. He was very talented in drawing Graphs back then in secondary School.
                                </p>
                                <a href="https://github.com/Stanjae/graphito-AlxProjectPortfolio.git" className="inline-flex gap-x-1 items-center text-indigo-600 hover:text-indigo-500 duration-150 font-medium">
                                    Check the Code
                        ...
                        <div className="max-w-screen-xl mx-auto px-4 flex-wrap gap-x-12 justify-between items-center md:flex md:px-8 lg:flex-nowrap">
                            <div className="max-w-xl space-y-3">
                                ...
                                <p className="text-white text-3xl font-semibold sm:text-4xl">
                                    Trusted by the best data analysist and top companies
                                </p>
                                <p className="text-gray-300">
                                    ta nunc vitae, gravida justo. Nunc fermentum.
                                </p>
                            </div>
                        ...
                        <div className="max-w-screen-xl mx-auto px-4 text-center md:px-8">
                            ...
                            <div className="mt-12">
                                <ul className="grid gap-8 sm:grid-cols-2">
                                    {
                                        team.map((item, idx) => (
                                            <li className=" col-span-2" key={idx}>
                                                ...
                                                <div className="mt-2">
                                                    <h4 className="text-gray-100 font-semibold sm:text-lg">{item.name}</h4>
